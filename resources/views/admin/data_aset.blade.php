                ...
                <form method="post" id="form_add" enctype="multipart/form-data"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <textarea name="catatan" style="max-width: 100%" class="form-control" id="catatan" rows="4"></textarea>
                                <button type="button" class="btn btn-sm btn-outline-primary mt-2" id="btn_catat"><i
                                        class="fa fa-edit"></i> Simpan Catatan</button>
                            </div>
...
@section('tambah_js')
    ...
    <script>
        ...
        $("#btn_catat").click(function() {
            id = $('#id_aset').val();
            catat = $('#catatan').val();

            $.ajax({
                url: "{{ route('admin.set.catat') }}",
                type: "get",
                data: {
                    catat: catat,
                    id: id,
